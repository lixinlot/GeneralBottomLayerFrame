...
//            CGContextSetStrokeColorWithColor(context, [[UIColor skyBlue]colorWithAlphaComponent:0.5].CGColor);
        }
        else {
            CGContextSetRGBStrokeColor(context, 208/255.f, 36/255.f, 36/255.f, 0.7);//红色
//             CGContextSetStrokeColorWithColor(context, [[UIColor colorWithRGB:@"#ff4e4e"]colorWithAlphaComponent:0.5].CGColor);
        }
