...
#import "HHFireworkAnimationButton.h"
#import "HHFireworkAnimationView.h"

@interface HHFireworkAnimationButton ()

@property (nonatomic, strong) HHFireworkAnimationView *fireworksView;

@end

@implementation HHFireworkAnimationButton
...
- (void)setup {
    ...
    _fireworksView = [[HHFireworkAnimationView alloc] init];
