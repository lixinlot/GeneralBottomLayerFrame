...
@interface ThreeSelectPickerView()<UIPickerViewDelegate,UIPickerViewDataSource>
{
    NSString *_recProv;//省
    NSString *_recCity;//市
    NSString *_recArea;//区
...
@implementation ThreeSelectPickerView

+(void)selectPickViewWithValueBlock:(ThreeSelectPickerViewBlock)valueBlock
{
    ThreeSelectPickerView * pickView = [[ThreeSelectPickerView alloc] init];
...
- (void)showPickView
{
    ...
    if (!self.pickerView){
        ...
        lineLabel.backgroundColor = FONTCOLOR_GRAY;
        ...
        [cancleBtn setTitleColor:FONTCOLOR_BLACK forState:UIControlStateNormal];
        ...
        achiveBtn.tag = 1;
        [achiveBtn setTitleColor:FONTCOLOR_BLACK forState:UIControlStateNormal];
