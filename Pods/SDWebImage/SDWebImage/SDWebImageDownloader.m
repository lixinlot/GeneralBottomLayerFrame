...
- (nonnull instancetype)initWithSessionConfiguration:(nullable NSURLSessionConfiguration *)sessionConfiguration {
    if ((self = [super init])) {
        ...
        _downloadQueue.maxConcurrentOperationCount = 6;//队列的最大并发数
        _downloadQueue.name = @"com.hackemist.SDWebImageDownloader";
        _URLOperations = [NSMutableDictionary new];//请求回调dic
#ifdef SD_WEBP
...
//该方法初始化了一些参数用于网络请求，SDWebImageDownloader是通过NSURLSession的方式请求数据。同时提供了一些方法用于外部设置。
//设置请求报文头部
